...
class UserModel(Base, TimestampMixin):
    ...
    def create(
        ...
        if not cls._is_password_match(password1=password1,
                                      password2=password2):
    ...
    def change_password(self, password1: str,
                        password2: str) -> Optional[NoReturn]:
        if not self._is_password_match(password1=password1,
                                       password2=password2):
            raise PasswordDoesNotMatchException
